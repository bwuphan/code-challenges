...
var divide = function(x, y) {
  var recursiveDiv = function(x, y, place) {
    ...
    if (place > 3) { 
      console.log('place greater than 3')
      return dividend >= 5; 
    }
    ...
    console.log('remainder div', remainderDiv)
    // If we stopped in the lower stack call, let's round (or not) and return
    if (typeof remainderDiv === 'boolean') { 
      console.log('IN BOOL')
