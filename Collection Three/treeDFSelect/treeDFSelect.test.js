...
describe('DFSelect', function() {
  ...
  it('should allow filtering by depth', function () {
    ...
    root.DFSelect(depthFilter(0)).should.eql(nodeDepths[0]);
    root.DFSelect(depthFilter(1)).should.eql(nodeDepths[1]);
    root.DFSelect(depthFilter(2)).should.eql(nodeDepths[2]);
    root.DFSelect(depthFilter(3)).should.eql(nodeDepths[3]);
  });
});
