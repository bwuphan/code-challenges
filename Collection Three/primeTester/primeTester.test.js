...
context('primeSieve', function () {
  it('EXTRA CREDIT: should be exist', function() {
    should.exist(primeSieve);
  });

  it('EXTRA CREDIT: should be a function', function() {
    primeSieve.should.be.a.Function;
  });

  it('EXTRA CREDIT: should take two arguments', function() {
    primeSieve.length.should.equal(2);
  });
  
  it('EXTRA CREDIT: should return an array', function() {
    should.exist(primeSieve(1, 10));
    primeSieve(1, 10).should.be.an.instanceOf(Array);
  });
  
  it('EXTRA CREDIT: should return an empty array between 20 and 22 (no primes)', function() {
    primeSieve(20, 22).should.eql([]);
  });

  it('EXTRA CREDIT: should return every prime between 1 and 2', function() {
  ...
  it('EXTRA CREDIT: should return every prime between 1 and 10', function() {
    primeSieve(1, 10).should.eql([2, 3, 5, 7]);
  });
  
  it('EXTRA CREDIT: should return the primes between 23 and 29 (inclusive)', function() {
    primeSieve(23, 29).should.eql([23, 29]);
  });

  it('EXTRA CREDIT: should return every prime between 2908 and 3080', function() {
